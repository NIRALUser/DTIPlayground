...
class DMRIFiberProfileApp(AppBase):

    ######### Mandatory Implementations Begins
    def __init__(self, config_root, app_name = 'dmrifiberprofile', *args, **kwargs):
    ...
    def initializeImpl(self, options):
        ...
        source_template_path=Path(fiberprofile.__file__).parent.joinpath("templates/protocol_template.yml")
    ...
    def runImpl(self,_options):
        return self.runFiberProfile(_options)
    ...
    def runFiberProfile(self,_options):
        ...
        def _run(_options):
            ...
            options={
                ...
                "input_file_paths" : _options['input_file_paths'],
...
#### working (API functions)
    ...
    def getUserModuleDirectory(self):
        return Path(self.app['config_dir']).joinpath('modules/dmrifiberprofile').__str__()
