...
def localTractography(tensorImage, dwi_image, dipyLabelmap, output_dir,**kwargs):
    ...
    logger("Computing dti parameters ...",common.Color.PROCESS)
    ...
    logger("Computing dti peaks ...",common.Color.PROCESS)
